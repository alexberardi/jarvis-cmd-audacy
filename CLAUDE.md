...
- **audacy** — Voice command (IJarvisCommand) (`commands/audacy/command.py`)
...
- **Shared code**: If you add shared modules, name the directory `audacy_shared/` (not `shared/`, `lib/`, `helpers/` — those collide on sys.path after install)
